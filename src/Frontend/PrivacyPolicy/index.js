    ...
    <Container>
      ...
      <div className="mt-3">
        <p>
          ...
          refer to <strong> RAJVEDA HERBS LIFE PRIVATE LIMITED</strong> and the
      ...
      <div>
        <p>
          ...
          RAJVEDA HERBS LIFE PRIVATE LIMITED (both terms defined below). The
          terms of this Privacy Policy will be effective upon your acceptance of
          the same (directly or indirectly in electronic form, by clicking on
          the I accept tab or by use of the website or by other means) and will
          govern the relationship between you and{" "}
          <strong> RAJVEDA HERBS LIFE PRIVATE LIMITED </strong> for your use of
          the website <strong>“Website”</strong> (defined below).
        </p>
      </div>
      <div>
        <p>
      ...
      <div>
        ...
        <p>
          <b>(a) </b> When it is requested or required by law or by any court or
        ...
        <p>
          <b>(b) </b> We proposes to share such information within its group
      ...
      <div>
        ...
        <p className="mt-2">
          ...
          Raushan Raj (“Grievance Officer”). 
        </p>
      </div>
      <span>
        Mr. Raushan Raj <b>(Grievance Officer)</b>
      </span>
      <br />
      <Link to="www.rajveda.com">www.rajveda.com</Link>
      <br />
      <span>
        <b>RAJVEDA HERBS LIFE PRIVATE LIMITED</b>
      </span>
      <p>
        201, Kohinoor Corporate, Tata Lane Ram Nagar, Dombivali East, Thane –
        Maharashtra - 421201 (India)
      </p>
      <span>Email: info@rajveda.com</span>
      <br />
      <span>PH:  +91-971-086-2222</span>
      </div>
    </Container>
  );
};
