    ...
    <Container>
      ...
      <div className="mt-3">
        <p>
          ...
          refer to <b> RAJVEDA HERBS LIFE PRIVATE LIMITED  </b>and the terms
      ...
      <div>
        ...
        <p className="mt-2">
          ...
          license, by the business and / or its associate entities who feature
      ...
      <div>
        ...
        <p className="mt-2">
          ...
          their use of <Link to="www.rajveda.com"> www.rajveda.com  </Link> or
        ...
        <p>
          ...
          including but not limited to director/and indirect or/and incidental
